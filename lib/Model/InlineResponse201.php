...
class InlineResponse201 implements ModelInterface, ArrayAccess
{
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date Start date in YYYY/MM/DD
     *
     * @return $this
     */
     ...
     * Sets end_date
     *
     * @param \DateTime $end_date End date in YYYY/MM/DD
     *
     * @return $this
     */
     ...
     * Sets open
     *
     * @param float $open Opening price quote of the time frame with two decimal points
     *
     * @return $this
     */
     ...
     * Sets close
     *
     * @param float $close Closing price quote of the time frame with two decimal points
     *
     * @return $this
     */
     ...
     * Sets high
     *
     * @param float $high Highest price of the time frame with two decimal points
     *
     * @return $this
     */
     ...
     * Sets vol
     *
     * @param float $vol Volume of currency exchanged in the time frame with two decimal points
     *
     * @return $this
     */
