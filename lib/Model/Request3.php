 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Request3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'request_3';
     ...
     * Sets data_format
     *
     * @param string $data_format Name of the data format availables (standard, OHCLV, VWAP, ticker, raw)
     *
     * @return $this
     */
